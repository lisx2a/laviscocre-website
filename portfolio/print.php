	...
	<div class="internal_content">
 		...
 		<div class="page_title">Portfolio | Print</div>

		<div class="left_column">
			<div id="gallery_closeup">
				<img src="http://dummyimage.com/409x242/ccc/fff.jpg&text=Click+Thumbnails" alt="Placeholder Initial Image Description" /></div>
		</div>
